function dontWorryAboutThis(){
	...
	function createBookStore(arr) {
		for (var i = 0; i < arr.length; i++) {
			bookStore.push(createBook(arr[i]));
		}

		return bookStore
	}

	return createBookStore(booksArray);
